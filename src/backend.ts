...
export class Backend implements backendInterface {
    ...
    async addAdvisor(arg0: Advisor): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addAdvisor(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllAdvisors(): Promise<Array<Advisor>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllAdvisors();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchByBranch(arg0: string): Promise<Array<Advisor>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchByBranch(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchByCollege(arg0: string): Promise<Array<Advisor>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchByCollege(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
